...
public class AuthController {
    ...
    public String customerDashboard(HttpSession session, Model model) {
        if (session.getAttribute("userId") == null) return "redirect:/customer-login";
        if (!"CUSTOMER".equals(session.getAttribute("userRole"))) return "redirect:/customer-login";
    ...
    public String adminDashboard(HttpSession session, Model model) {
        if (session.getAttribute("userId") == null) return "redirect:/admin-login";
